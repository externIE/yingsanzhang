...
#define		GR_ASK_RANDOM_TABLE		  (GAME_REQ_BASE_EX + 1302)	

#define     GR_APPLY_BASEWELFARE	  (GAME_REQ_BASE_EX + 14000)	// 申请低保
#define     GR_APPLY_BASEWELFARE_EX	  (GAME_REQ_BASE_EX + 14001)	// 申请低保 带硬件标识
#define		GR_GET_WELFARECONFIG	  (GAME_REQ_BASE_EX + 14010)	// 获取低保配置
#define		GR_LOTTERY_READ			  (GAME_REQ_BASE_EX + 14100)	// 抽奖-读
#define		GR_LOTTERY_WRITE		  (GAME_REQ_BASE_EX + 14101)	// 抽奖-写
#define		GR_LOTTERY_DRAW			  (GAME_REQ_BASE_EX + 14102)	// 抽奖-到保险箱
#define		GR_LOTTERY_DRAW_TOGAME	  (GAME_REQ_BASE_EX + 14104)	// 抽奖-到游戏
#define		GR_LOTTERY_BROADCAST	  (GAME_REQ_BASE_EX + 14103)	// 抽奖-广播
...
#define		GR_START_COUNTDOWN					 (GAME_REQ_BASE_EX + 11501)		// 开始游戏倒计时
#define		GR_SYNC_START_COUNTDOWN				 (GAME_REQ_BASE_EX + 11502)		// 同步开始游戏倒计时
#define		GR_USER_BOUT_END					 (GAME_REQ_BASE_EX + 11510)		// 同步开始游戏倒计时
//
...
#define		GR_KICKOFF_IDLEPLAYER				 (GAME_REQ_BASE_EX + 11800)		// 踢掉连续不参与游戏的idle玩家
#define		GR_SCORE_PROTECTOR					 (GAME_REQ_BASE_EX + 11900)     // 发动会员或服装的积分技能
//////////////////////////////////////////////////////////////////////////
//Add on 20130115
//Look card request
...
#define		GR_USER_CLOTHING					 (GAME_REQ_BASE_EX + 11430)		 
#define		GR_USER_BEMEMBER					 (GAME_REQ_BASE_EX + 11440)		 

//////////////////////////////////////////////////////////////////////////
//Mobile request, id from 300000
#define		MR_GET_VERSION				(MOBILE_REQ_BASE_EX + 1)			// 获取版本信息
#define		MR_ENTER_BACKGROUND			(MOBILE_REQ_BASE_EX + 50)			// 移动app进入后台	
#define		MR_ENTER_FOREGROUND			(MOBILE_REQ_BASE_EX + 51)			// 移动app回到前台
