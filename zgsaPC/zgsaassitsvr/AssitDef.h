...
#define		PRODUCT_NAME			_T("ZgsaAssitSvr")
#define		PRODUCT_VERSION			_T("1.00")
#define     STR_SERVICE_NAME		_T("ZgsaAssitSvr")
#define     STR_DISPLAY_NAME		_T("同城游打大A辅助服务")
#define     STR_DISPLAY_NAME_ENU	_T("TCY Zgsa Assit Service") 
